...
public class LogDAO extends EAVObjectDAO {
    ...
    @Transactional
    public Page<LogDTO> getLogByDirectoryId(BigInteger directoryId, RuleContainer ruleContainer, Pageable pageable) {
        ...
        BigInteger totalRows = namedParameterJdbcTemplate.queryForObject(GET_TOTAL_LOGS_COUNT_BY_DIRECTORY_AND_RULE_QUERY, parameterSourceCount, BigInteger.class);
    ...
    public Page<LogDTO> getLogByFileId(BigInteger fileId, RuleContainer ruleContainer, Pageable pageable) {
        ...
        BigInteger totalRows = namedParameterJdbcTemplate.queryForObject(GET_TOTAL_LOGS_COUNT_BY_FILE_AND_RULE_QUERY, parameterSourceCount, BigInteger.class);
